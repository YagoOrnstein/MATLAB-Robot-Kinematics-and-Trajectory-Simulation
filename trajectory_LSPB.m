...
% Synchronize the trajectories for each joint
[q_lspb, t_max_lspb] = LSPBTrajectory(p0, v0, pf, vf, t0, tf, timestep); 

% Plot LSPB Trajectory
T = robot.fkine(q_lspb); 
p = transl(T);
figure('name','LSPB Trajectory')
